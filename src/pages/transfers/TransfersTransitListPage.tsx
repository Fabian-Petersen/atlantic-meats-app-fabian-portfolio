...
const TransfersTransitListPage = () => {
  const navigate = useNavigate();
  const { data, isPending, isError } = useGetAll<TransferTransitTableRow[]>({
    resourcePath: "api/transfers/requests",
    queryKey: ["transfers", "in_transit-list"],
    params: {
      status: "in-transit",
    },
  });

  console.log("TransfersTransitListPage data:", data);
...
export default TransfersTransitListPage;
