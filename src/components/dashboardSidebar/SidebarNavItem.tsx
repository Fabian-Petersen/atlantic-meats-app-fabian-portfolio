  ...
  return (
    <div className="w-full list-none">
      <button
        type="button"
        onClick={onClick}
        className={`group flex p-2 w-full rounded-lg items-center gap-4 lg:gap-4 py-3 px-4 text-gray-600 dark:text-fontlight hover:dark:text-gray-300 hover:dark:bg-primary/50 hover:bg-primary/20 hover:font-medium hover:cursor-pointer ${
          isActive &&
