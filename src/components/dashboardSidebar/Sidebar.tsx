    ...
    <AnimatePresence initial={false}>
      {(isOpen ||
        ...
        <motion.div
          ...
          className="z-200 w-(--sidebarWidth) fixed lg:top-(--lg-navbarHeight) h-(--sm-sidebarHeight) lg:h-(--lg-sidebarHeight) overflow-auto no-scrollbar border-r border-r-gray-200 dark:border-r-gray-700 bg-white dark:bg-(--bg-primary_dark) lg:translate-x-0"
        >
