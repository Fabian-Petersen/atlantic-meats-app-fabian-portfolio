...
const NotificationSidebar = () => {
  ...
  return (
    <div
      className={`overflow-y-scroll custom-scrollbar right-0 z-1000 w-80 lg:w-96 fixed top-(--sm-navbarHeight) md:top-(--lg-navbarHeight) h-(--sm-sidebarHeight) md:h-(--lg-sidebarHeight) border-l border-l-gray-200 dark:border-l-[rgba(55,65,81,0.5)]
