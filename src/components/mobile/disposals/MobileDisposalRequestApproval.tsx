...
type MobileDisposalRequestApprovalProps = {
...
export default function MobileDisposalRequestApproval({
  item,
  selectedAssetIndex,
  onSelectAsset,
}: MobileDisposalRequestApprovalProps) {
  const {
    selectedRowId,
    ...
    <div className={cn(sharedStyles.cardParent, "")}>
      ...
      <div className={cn(sharedStyles.cardTopBar)}>
        ...
        <div className="flex-1 text-center">
          <p className="text-xs text-gray-400 dark:text-gray-500">Disposal</p>
      ...
      <div className="flex-1 overflow-y-auto pb-32">
        ...
        >
          <CardRow
            icon={User}
            label="Requested by"
            value={item?.pending?.requestorName || item?.pending?.requestedBy}
            className={cn("py-3")}
          />
          <CardRow
            icon={MapPin}
