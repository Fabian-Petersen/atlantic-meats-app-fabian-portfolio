 ...
 *
 * A transfer request can now bundle more than one asset (`request.assets`
 * is an array). The pill selector below the header lets the user flip
 * between assets — the image gallery and the "Transfer details" fields on
 * the request tab both follow the selected asset. In-transit / received
 * images are transfer-level (not per-asset), so they aren't affected by
 * this selector.
 *
